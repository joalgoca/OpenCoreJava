...
<%
    String mensaje="Disculpe las molestias, ha ocurrido un error en el sistema.<br/>Favor de reportarlo al administrador.";
...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
    <head>   
        ...
        <title>${initParam.appName} - error del sistema</title>
